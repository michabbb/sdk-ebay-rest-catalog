...
**parameters** | [**\macropage\SDKs\ebay\rest\catalog\Model\ErrorParameter[]**](ErrorParameter.md) | An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned. | [optional]
