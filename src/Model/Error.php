...
class Error implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'message' => 'string',
        'outputRefIds' => 'string[]',
        'parameters' => '\macropage\SDKs\ebay\rest\catalog\Model\ErrorParameter[]',
        'subdomain' => 'string'
    ];
    ...
    */
     ...
     * Gets parameters
     *
     * @return \macropage\SDKs\ebay\rest\catalog\Model\ErrorParameter[]|null
     */
     ...
     * Sets parameters
     *
     * @param \macropage\SDKs\ebay\rest\catalog\Model\ErrorParameter[]|null $parameters An array of name/value pairs that describe details the error condition. These are useful when multiple errors are returned.
     *
     * @return self
     */
